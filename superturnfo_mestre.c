...
////////////////////////////////////////////////// VARIÁVEIS DAS CARTAS 1 E 2: //////////////////////////////////////////////////
    ...
    float  superpoder;              //<--Variável para armazenar o super poder de cada carta.//
    float  superpoder2;             //////////////////////////////////////////////////////////
    
    int resutadopoptotal;
    int resultadoarea;
    int resultadopib;
    int resultadopontosturisticos;
    int resultadopibpercapita;
    int resultadoDpopulacional;
...
////////////////////////////////////////////// LEITURA DE DADOS DAS CARTAS 1 E 2: //////////////////////////////////////////////
    ...
    superpoder = poptotal + area + pib + pontosturisticos + pibpercapita + Dpopulacional;
    ...
    printf("\n|Densidade Populacional: %fHab/km²", Dpopulacional);
    ...
    superpoder2 = poptotal2 + area2 + pib2 + pontosturisticos2 + pibpercapita2 + Dpopulacional2;
    ...
    printf("\n|Densidade Populacional: %f Hab/km²", Dpopulacional2);
...
////////////////////////////////////////////////// EXIBIÇÃO DAS CARTAS 1 E 2: //////////////////////////////////////////////////
    ...
    printf("\n|Pontos turísticos: %d  ", pontosturisticos);
    printf("\n|PIB per Capita: R$%f", pibpercapita);
    printf("\n|Densidade Populacional: %f Hab/km²", Dpopulacional);
    printf("\n|Super Poder: %f", superpoder);
    printf("\n|_______________________|\n\n\n");
    ...
    printf("É hora de compara-las e ver qual delas é a vencedora!\n");
    printf("Se o resultado for 1, a carta 1 vence, se for 0, a carta 2 vence.\n\n");
    printf("Boa sorte, %s!\n\n", nome);
    ...
    resutadopoptotal = poptotal > poptotal2;
    ...
    resultadoDpopulacional = Dpopulacional < Dpopulacional2;
    ...
    printf("Densidade Populacional: %d\n", resultadoDpopulacional);
    printf("Super Poder: %d\n", resultadosuperpoder);

    printf("\n\nAgora veja se sua ganhou ou perdeu!\n");
